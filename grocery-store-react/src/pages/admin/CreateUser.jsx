            ...
            <div class="container">
                <form id="userForm">
                    <div class="form-header">
                        ...
                        <p>Seja bem-vindo administrador! Crie o cadastro de um usuário para uma experiência sustentável.</p>
                    </div>
                        ...
                        <div>
                            <div className="form-row">
                                <div className="form-group">
                                    ...
                                    <input type="text" id="rua" placeholder='Digite o nome da sua rua'/>
                                </div>

                                <div className="form-group">
                                    <label htmlFor="numero_rua">Número</label>
                                    <input type="text" id='numero_rua' placeholder='Digite o número da rua'/>
                                </div>
                            </div>
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    ...
                                    <input type="text" id='complemento' placeholder='Ex: Nome do edifício, Bloco, Apto'/>
                                </div>
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" id='pais' placeholder='Digite o seu país' required/>
                                </div>
